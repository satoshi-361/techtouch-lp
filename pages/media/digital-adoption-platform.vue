...
export default class extends Vue {
  ...
  meta = {
    title: 'デジタルアダプションプラットフォームとは？ そのメリットと導入時の注意点',
    description: 'ビジネスにおいて新たなシステムの導入を行う際、だれもが簡単にシステムを扱えるようになる状態を示す言葉がデジタルアダプションです。DAP（デジタルアダプションプラットフォーム）は、デジタルアダプションを実現させるためのツールです。今回は DAP の概要やメリット、活用場面をお伝えします。',
    type: 'article',
    keywords: '',
    url: 'https://techtouch.jp/media/digital-adoption-platform',
    image: 'https://images.microcms-assets.io/assets/ad300821ff4546ccb965bd0b044ddd84/7c1a043fa1c043a7bbe651b691e3c063/1_69271748.jpg'
  }
  ...
  async mounted () {
    try {
      const response = (await axios.get(`https://tt-media.microcms.io/api/v1/articles?filters=slug[equals]digital-adoption-platform`,{ headers: { 'X-MICROCMS-API-KEY': 'd1a6e286587b42d0b937900a99167ed10e76' } })).data
