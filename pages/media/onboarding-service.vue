...
export default class extends Vue {
  ...
  meta = {
    title: 'SaaSビジネスのオンボーディングを支援するサービスとは？メリットと活用のポイントを紹介',
    description: 'SaaSビジネスにおいて重要なオンボーディング。しかしオンボーディングの構築には多くの手間とコストがかかるなど、いくつかの課題があります。そこで課題の解決策として、オンボーディングをサポートする外部サービスを活用する方法があります。外部サポートを活用するメリットやポイントを紹介します。',
    type: 'article',
    keywords: '',
    url: 'https://techtouch.jp/media/onboarding-service',
    image: 'https://images.microcms-assets.io/assets/ad300821ff4546ccb965bd0b044ddd84/4fb829d76c634842b2e1bcb6ebd44be1/3_49151990.jpg'
  }
  ...
  async mounted () {
    try {
      const response = (await axios.get(`https://tt-media.microcms.io/api/v1/articles?filters=slug[equals]onboarding-service`,{ headers: { 'X-MICROCMS-API-KEY': 'd1a6e286587b42d0b937900a99167ed10e76' } })).data
