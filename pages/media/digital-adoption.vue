...
export default class extends Vue {
  ...
  meta = {
    title: 'DXの実現に欠かせないデジタルアダプションとは？実現による効果と課題を解説',
    description: '経済産業省が推し進めるDX。しかし思ったような成果を上げている企業はそれほど多くはありません。そこで、だれもが簡単にシステムを扱えるようになり、DX実現に効果を発揮するデジタルアダプションが注目されています。デジタルアダプションの概要や実現させるためのポイントをお伝えします。',
    type: 'article',
    keywords: '',
    url: 'https://techtouch.jp/media/digital-adoption',
    image: 'https://images.microcms-assets.io/assets/ad300821ff4546ccb965bd0b044ddd84/95435b61a5a84729a3a8725e134bfe2e/2_81875916.jpg'
  }
  ...
  async mounted () {
    try {
      const response = (await axios.get(`https://tt-media.microcms.io/api/v1/articles?filters=slug[equals]digital-adoption`,{ headers: { 'X-MICROCMS-API-KEY': 'd1a6e286587b42d0b937900a99167ed10e76' } })).data
